...
6-concat.py: Python script that prints Welcome to Holberton School! using the variables str1 = "Givforks" and str2 = "Project".
Completion of this source code.
7. Copy - Cut - Paste
...
102-magic_calculation.py: Python function matching exactly a bytecode provided by Givforks Project.
